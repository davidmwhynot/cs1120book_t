...
/**
	This program demonstrates setting and remove list elements with a ListIterator.
*/
...
public class ListIteratorDemo4 {
	public static void main(String[] args) {
		...
		// Display the names in the list again. The list should read Alfonso, David, and Katherine.
