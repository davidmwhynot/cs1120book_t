...
/**
	This program stores Car objects in a HashSet and then searches for various objects.
*/
...
public class CarHashSet {
	public static void main(String[] args) {
		...
		System.out.println("Search for " + mustang);
		...
		System.out.println("Search for " + plymouth);
