...
public class ListIteratorDemo3 {
	public static void main(String[] args) {
		...
		// Display the names in the listIterator
		...
		// Create a flag variable to indicate when we've inserted a name into the list.
		boolean done = false;
		...
		while(!done && it.hasNext()) {
			...
			// If the last element retrieved was "Crhis" then insert "Darlene".
			if(str.compareToIgnoreCase("Chris") == 0) {
				// Insert the name after the element we just retrieved.
				it.add("Darlene");
